...
import bsu.rfict.lab8.entity.ChatUser;
...
public class LoginServlet extends ChatServlet {
    ...
    //Задаем количества пользователей
    private int KolCh = 1;
...
// восстановить имя через cookie
        ...
        // Вывести форму
        pw.println("<form action='/Lab_8/' method='post'>Введите имя:" +
...
// Иначе вместо символов будет абракадабра
        ...
        if (name==null || "".equals(name)) {
            ...
            errorMessage = "Извините, но количество пользователей в чате ограничено" ;
        else{
